---
title: "FDQ 09: IRAC without Research Pack"
sidebar:
  order: 13
---

# FDQ: d9 — IRAC without Research Pack  
...
| **Scoring**         | Judge (MEE rubric; graded alongside j10) |
...
**Boundary:** d9 is anchor-only; no Research Pack is available.
...
* Eligible when the chain reaches d9 in the normal plan.
...
**Important:** d9 is not scored immediately in isolation. The judge grades **both d9 + j10** after j10 completes, in a single judge call.
