...
**Architecture:** Keep the page unchanged. Implement only the smallest Kestra-compatible backend contract required for this page. Back the endpoint with one query layer and one mapper layer.
...
**Files:**
- Modify: `docs/worker-system/tasks/<page_key>.capture.md`
- Reference: `openapi.yml`

**Step 1: Verify the exact route and store/client call**
...
**Files:**
- Modify: `docs/worker-system/tasks/<page_key>.verify.md`
