...
# WARNING: Unresolved types: ChronoUnit
...
class AbstractJdbcMetricRepository(ABC, AbstractJdbcCrudRepository):
    ...
    def aggregate(self, tenant_id: str, condition: Condition | None = None, start_date: datetime | None = None, end_date: datetime | None = None, aggregation: str | None = None) -> list[MetricAggregation]:
        raise NotImplementedError  # TODO: translate from Java

    def fill_date(self, result: list[MetricAggregation], start_date: datetime, end_date: datetime, unit: ChronoUnit | None = None, format: str | None = None) -> list[MetricAggregation]:
        raise NotImplementedError  # TODO: translate from Java
