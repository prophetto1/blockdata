...
class RunContextSDKFactory:
    ...
    class SDKImpl:
        a_u_t_h__p_r_o_p: ClassVar[str] = "kestra.tasks.sdk.authentication"
        a_p_i__t_o_k_e_n__p_r_o_p: ClassVar[str] = AUTH_PROP + ".api-token"
        u_s_e_r_n_a_m_e__p_r_o_p: ClassVar[str] = AUTH_PROP + ".username"
        p_a_s_s_w_o_r_d__p_r_o_p: ClassVar[str] = AUTH_PROP + ".password"
