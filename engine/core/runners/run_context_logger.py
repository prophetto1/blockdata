...
class RunContextLogger:
    m_a_x__m_e_s_s_a_g_e__l_e_n_g_t_h: int = 1024 * 15
    o_r_i_g_i_n_a_l__t_i_m_e_s_t_a_m_p__k_e_y: str = "originalTimestamp"
    ...
    class BaseAppender(AppenderBase):
    ...
    class FileAppender(BaseAppender):
        l_o_g_g_e_r: ch.qos.logback.classic.Logger = (ch.qos.logback.classic.Logger) LoggerFactory.getLogger("flow")
        p_a_t_t_e_r_n__l_a_y_o_u_t: PatternLayout = new PatternLayout()
