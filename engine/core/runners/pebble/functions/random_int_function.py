...
# Source: E:\KESTRA\core\src\main\java\io\kestra\core\runners\pebble\functions\RandomIntFunction.java
...
class RandomIntFunction:
    ...
    def get_argument(self, args: dict[str, Any], arg: str, self: PebbleTemplate, line_number: int) -> int:
        raise NotImplementedError  # TODO: translate from Java
