...
# WARNING: Unresolved types: EvaluationContext, Function, PebbleTemplate, TimeBasedEpochRandomGenerator
...
class UUIDFunction:
    generator: ClassVar[TimeBasedEpochRandomGenerator] = Generators.timeBasedEpochRandomGenerator()
