...
# Source: E:\KESTRA\core\src\main\java\io\kestra\core\runners\pebble\expression\UndefinedCoalescingExpression.java
...
class UndefinedCoalescingExpression(BinaryExpression):
