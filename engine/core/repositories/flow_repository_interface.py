...
class FlowRepositoryInterface(QueryBuilderInterface, Protocol):
    def find_by_id(self, tenant_id: str, namespace: str, id: str, revision: Optional[int] | None = None, allow_deleted: bool | None = None) -> Optional[Flow]: ...
    ...
    def find_by_id_with_source(self, tenant_id: str, namespace: str, id: str, revision: Optional[int] | None = None, allow_delete: bool | None = None) -> Optional[FlowWithSource]: ...
    ...
    def find_distinct_namespace(self, tenant_id: str, prefix: str | None = None) -> list[str]: ...
