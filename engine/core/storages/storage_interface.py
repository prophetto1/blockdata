...
# WARNING: Unresolved types: FileNotFoundException, NoSuchFileException
...
class StorageInterface(AutoCloseable, Plugin, Protocol):
    ...
    def put(self, tenant_id: str, namespace: str, uri: str, data: Any) -> str: ...

    def put_instance_resource(self, namespace: str, uri: str, data: Any) -> str: ...
    ...
    def get_path(self, tenant_id: str, uri: str | None = None) -> str: ...
