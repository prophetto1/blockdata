...
# WARNING: Unresolved types: ConversionContext, TypeConverter
...
class PluginDefaultConverter:
    ...
    def convert(self, map: dict, target_type: type[PluginDefault], context: ConversionContext) -> Optional[PluginDefault]:
