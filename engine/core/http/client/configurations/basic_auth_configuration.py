...
# Source: E:\KESTRA\core\src\main\java\io\kestra\core\http\client\configurations\BasicAuthConfiguration.java
...
class BasicAuthConfiguration(AbstractAuthConfiguration):
