...
class EncryptionService:
    c_i_p_h_e_r__a_l_g_o_r_i_t_h_m: str = "AES/GCM/NoPadding"
    k_e_y__a_l_g_o_r_i_t_h_m: str = "AES"
    i_v__l_e_n_g_t_h: int = 12
    a_u_t_h__t_a_g__l_e_n_g_t_h: int = 128
    s_e_c_u_r_e__r_a_n_d_o_m: SecureRandom = new SecureRandom()
