...
class Switch(Task):
    ...
    value: Property[str]
    cases: dict[str, list[Task]] | None = None
    defaults: list[Task] | None = None
    ...
    def renderer_value(self, run_context: RunContext) -> str:
        raise NotImplementedError  # TODO: translate from Java
    ...
    def outputs(self, run_context: RunContext) -> Switch.Output:
        raise NotImplementedError  # TODO: translate from Java
