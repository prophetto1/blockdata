...
# Source: E:\KESTRA\core\src\main\java\io\kestra\plugin\core\flow\EachSequential.java
...
class EachSequential(Sequential):
    """Iterate values sequentially (deprecated)."""
    value: Any
