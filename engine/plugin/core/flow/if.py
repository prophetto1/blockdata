...
# Source: E:\KESTRA\core\src\main\java\io\kestra\plugin\core\flow\If.java
...
class If(Task):
    ...
    then: list[Task] | None = None
    _else: list[Task] | None = None
    ...
    def outputs(self, run_context: RunContext) -> If.Output:
        raise NotImplementedError  # TODO: translate from Java

    def is_true(self, run_context: RunContext) -> bool:
        raise NotImplementedError  # TODO: translate from Java
