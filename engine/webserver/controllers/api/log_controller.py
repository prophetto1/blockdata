...
# WARNING: Unresolved types: Flux, HttpStatusException, Level, StreamedFile
...
class LogController:
    ...
    def search_logs(self, page: int, size: int, sort: list[str], filters: list[QueryFilter], query: str, namespace: str, flow_id: str, trigger_id: str, min_level: Level, start_date: datetime, end_date: datetime) -> PagedResults[LogEntry]:
        raise NotImplementedError  # TODO: translate from Java

    def list_logs_from_execution(self, execution_id: str, min_level: Level, task_run_id: str, task_id: str, attempt: int) -> list[LogEntry]:
        raise NotImplementedError  # TODO: translate from Java

    def download_logs_from_execution(self, execution_id: str, min_level: Level, task_run_id: str, task_id: str, attempt: int) -> HttpResponse[StreamedFile]:
        raise NotImplementedError  # TODO: translate from Java

    def follow_logs_from_execution(self, execution_id: str, min_level: Level) -> Flux[Event[LogEntry]]:
        raise NotImplementedError  # TODO: translate from Java

    def delete_logs_from_execution(self, execution_id: str, min_level: Level, task_run_id: str, task_id: str, attempt: int) -> None:
        raise NotImplementedError  # TODO: translate from Java
