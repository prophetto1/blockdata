...
class DashboardAiCopilot(AbstractAiCopilot):
    a_l_r_e_a_d_y__v_a_l_i_d__m_e_s_s_a_g_e: str = "This dashboard already performs the requested action. Please provide additional instructions if you would like to request modifications."
    n_o_n__r_e_q_u_e_s_t__e_r_r_o_r: str = "I can only assist with creating Kestra dashboards."
    u_n_a_b_l_e__t_o__g_e_n_e_r_a_t_e__e_r_r_o_r: str = "The prompt did not provide enough information to generate a valid dashboard. Please clarify your request."
