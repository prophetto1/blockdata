...
class MetadataAppenderChatModelListener:
    s_p_a_n__n_a_m_e: str = "spanName"
    p_a_r_e_n_t__i_d: str = "parentId"
    s_t_a_r_t__t_i_m_e__k_e_y__n_a_m_e: str = "startTime"
    c_o_n_v_e_r_s_a_t_i_o_n__i_d: str = "conversationId"
    i_p: str = "ip"
    i_n_s_t_a_n_c_e__u_i_d: str = "instanceUid"
    p_r_o_v_i_d_e_r: str = "provider"
