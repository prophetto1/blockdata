...
# Source: E:\KESTRA-IO\plugins\plugin-singer\src\main\java\io\kestra\plugin\singer\taps\Shopify.java
...
class Shopify(AbstractPythonTap):
    """Fetch data from a Shopify account with a Singer tap."""
    shop: str
    api_key: str
    start_date: date
