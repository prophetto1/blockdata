...
# Source: E:\KESTRA-IO\plugins\plugin-singer\src\main\java\io\kestra\plugin\singer\taps\Marketo.java
...
class Marketo(AbstractPythonTap):
    """Fetch data from a Marketo account with a Singer tap."""
    endpoint: str
    identity: str
    client_id: str
    client_secret: str
