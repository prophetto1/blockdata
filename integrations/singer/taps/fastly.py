...
# Source: E:\KESTRA-IO\plugins\plugin-singer\src\main\java\io\kestra\plugin\singer\taps\Fastly.java
...
class Fastly(AbstractPythonTap):
    """Fetch data from a Fastly account with a Singer tap."""
    api_token: str
    start_date: date
