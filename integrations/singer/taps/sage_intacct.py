...
# Source: E:\KESTRA-IO\plugins\plugin-singer\src\main\java\io\kestra\plugin\singer\taps\SageIntacct.java
...
class SageIntacct(AbstractPythonTap):
    """Fetch data from a Sage Intacct account with a Singer tap."""
    company_id: str
    sender_id: str
    sender_password: str
    user_id: str
