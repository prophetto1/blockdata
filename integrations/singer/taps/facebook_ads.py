...
# Source: E:\KESTRA-IO\plugins\plugin-singer\src\main\java\io\kestra\plugin\singer\taps\FacebookAds.java
...
class FacebookAds(AbstractPythonTap):
    """Fetch data from Facebook Ads with a Singer tap."""
    account_id: str
    access_token: str
    start_date: date
    insights_buffer_days: Property[int] = Property.ofValue(0)
