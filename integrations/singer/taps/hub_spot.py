...
# Source: E:\KESTRA-IO\plugins\plugin-singer\src\main\java\io\kestra\plugin\singer\taps\HubSpot.java
...
class HubSpot(AbstractPythonTap):
    ...
    start_date: date
    redirect_uri: Property[str] = Property.ofValue("https://api.hubspot.com/")
