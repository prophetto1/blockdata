...
# Source: E:\KESTRA-IO\plugins\plugin-singer\src\main\java\io\kestra\plugin\singer\taps\Recharge.java
...
class Recharge(AbstractPythonTap):
    """Fetch data from a Recharge account with a Singer tap."""
    access_token: str
    start_date: date
