...
# Source: E:\KESTRA-IO\plugins\plugin-singer\src\main\java\io\kestra\plugin\singer\taps\GitHub.java
...
class GitHub(AbstractPythonTap):
    """Fetch data from GitHub API with a Singer tap."""
    access_token: str
    repositories: Any
    start_date: date
    request_timeout: Property[int] = Property.ofValue(300)
