...
class PipelinewiseMysql(AbstractPythonTap, RunnableTask):
    ...
    export_batch_rows: Property[int] | None = None
    session_sqls: Property[list[String]] | None = None
    pip_package: str | None = None
    comand: str | None = None
