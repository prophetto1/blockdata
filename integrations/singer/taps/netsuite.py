...
# Source: E:\KESTRA-IO\plugins\plugin-singer\src\main\java\io\kestra\plugin\singer\taps\Netsuite.java
...
class Netsuite(AbstractPythonTap):
    """Fetch data from a Netsuite account with a Singer tap."""
    account_id: str
    consumer_key: str
    consumer_secret: str
    token_key: str
