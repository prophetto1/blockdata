...
# Source: E:\KESTRA-IO\plugins\plugin-pagerduty\src\main\java\io\kestra\plugin\pagerduty\AbstractPagerDutyConnection.java
...
class AbstractPagerDutyConnection(ABC, Task):
