...
# Source: E:\KESTRA-IO\plugins\plugin-email\src\main\java\io\kestra\plugin\email\RealTimeTrigger.java
...
class RealTimeTrigger(AbstractMailTrigger):
    ...
    def create_realtime_email_stream(self, run_context: RunContext, config: MailService.MailConfiguration) -> Flux[MailService.EmailData]:
        raise NotImplementedError  # TODO: translate from Java

    def create_imap_idle_stream(self, run_context: RunContext, config: MailService.MailConfiguration) -> Flux[MailService.EmailData]:
        raise NotImplementedError  # TODO: translate from Java

    def cleanup_imap_resources(self, run_context: RunContext, store: Store, folder: IMAPFolder) -> None:
        raise NotImplementedError  # TODO: translate from Java

    def create_pop3_polling_stream(self, run_context: RunContext, config: MailService.MailConfiguration) -> Flux[MailService.EmailData]:
        raise NotImplementedError  # TODO: translate from Java
