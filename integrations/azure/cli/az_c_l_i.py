...
# Source: E:\KESTRA-IO\plugins\plugin-azure\src\main\java\io\kestra\plugin\azure\cli\AzCLI.java
...
class AzCLI(Task):
    ...
    d_e_f_a_u_l_t__i_m_a_g_e: ClassVar[str] = "mcr.microsoft.com/azure-cli"
    ...
    def get_login_commands(self, run_context: RunContext) -> list[str]:
        raise NotImplementedError  # TODO: translate from Java
