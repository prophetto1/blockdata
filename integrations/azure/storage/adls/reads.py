...
# Source: E:\KESTRA-IO\plugins\plugin-azure\src\main\java\io\kestra\plugin\azure\storage\adls\Reads.java
...
class Reads(AbstractDataLakeConnection):
    ...
    def run(self, run_context: RunContext) -> Reads.Output:
