...
# Source: E:\KESTRA-IO\plugins\plugin-azure\src\main\java\io\kestra\plugin\azure\storage\cosmosdb\CreateItem.java
...
class CreateItem(AbstractCosmosContainerTask):
    ...
    class Output:
        ...
        @staticmethod
        def from(r: com.azure.cosmos.models.CosmosItemResponse[dict[str, Any]]) -> Output:
            raise NotImplementedError  # TODO: translate from Java
