...
# Source: E:\KESTRA-IO\plugins\plugin-azure\src\main\java\io\kestra\plugin\azure\storage\blob\DeleteList.java
# WARNING: Unresolved types: BlobContainerClient, Exception, Filter, Function, Logger, core, io, kestra, models, tasks
...
class DeleteList(AbstractBlobStorageWithSas):
    ...
    @staticmethod
    def delete(logger: Logger, container_client: BlobContainerClient) -> Function[Blob, int]:
        raise NotImplementedError  # TODO: translate from Java
