...
# Source: E:\KESTRA-IO\plugins\plugin-azure\src\main\java\io\kestra\plugin\azure\batch\models\OutputFileBlobContainerDestination.java
...
class OutputFileBlobContainerDestination:
    container_url: Property[str]
    path: Property[str] | None = None
    identity_reference: ComputeNodeIdentityReference | None = None

    def to(self, run_context: RunContext) -> com.microsoft.azure.batch.protocol.models.OutputFileBlobContainerDestination:
