...
# Source: E:\KESTRA-IO\plugins\plugin-googleworkspace\src\main\java\io\kestra\plugin\googleworkspace\chat\AbstractChatConnection.java
...
class AbstractChatConnection(ABC, Task):
