...
# Source: E:\KESTRA-IO\plugins\plugin-slack\src\main\java\io\kestra\plugin\slack\app\conversations\SetTopic.java
...
class SetTopic(AbstractSlackClientConnection):
