...
# Source: E:\KESTRA-IO\plugins\plugin-hubspot\src\main\java\io\kestra\plugin\hubspot\AbstractUpdateTask.java
...
class AbstractUpdateTask(ABC, HubspotConnection):
