...
# Source: E:\KESTRA-IO\plugins\plugin-modal\src\main\java\io\kestra\plugin\modal\cli\ModalCLI.java
...
class ModalCLI(Task):
    ...
    d_e_f_a_u_l_t__i_m_a_g_e: ClassVar[str] = "ghcr.io/kestra-io/modal"
