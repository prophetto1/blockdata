...
# Source: E:\KESTRA-IO\plugins\plugin-trello\src\main\java\io\kestra\plugin\trello\cards\Trigger.java
# WARNING: Unresolved types: Exception, HttpRequestBuilder, JsonNode, core, io, kestra, models, tasks
...
class Trigger(AbstractTrigger):
    ...
    lists: Property[list[str]] | None = None
    ...
    def add_auth_headers(self, api_key: str, api_token: str, builder: HttpRequest.HttpRequestBuilder) -> HttpRequest.HttpRequestBuilder:
        raise NotImplementedError  # TODO: translate from Java
