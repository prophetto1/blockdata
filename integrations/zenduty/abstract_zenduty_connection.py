...
# Source: E:\KESTRA-IO\plugins\plugin-zenduty\src\main\java\io\kestra\plugin\zenduty\AbstractZendutyConnection.java
...
class AbstractZendutyConnection(ABC, Task):
