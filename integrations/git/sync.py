...
class Sync(AbstractCloningTask, RunnableTask):
    """Deprecated: sync flows and Namespace Files"""
    f_l_o_w_s__d_i_r_e_c_t_o_r_y: str | None = None
    n_a_m_e_s_p_a_c_e__f_i_n_d_e_r__p_a_t_t_e_r_n: Pattern | None = None
    f_l_o_w__i_d__f_i_n_d_e_r__p_a_t_t_e_r_n: Pattern | None = None
    ...
    def log_deletion(self, logger: Logger, path: str) -> None:
        raise NotImplementedError  # TODO: translate from Java

    def log_addition(self, logger: Logger, path: str) -> None:
        raise NotImplementedError  # TODO: translate from Java

    def log_update(self, logger: Logger, path: str) -> None:
        raise NotImplementedError  # TODO: translate from Java
