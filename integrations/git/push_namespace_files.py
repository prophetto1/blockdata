...
# Source: E:\KESTRA-IO\plugins\plugin-git\src\main\java\io\kestra\plugin\git\PushNamespaceFiles.java
...
class PushNamespaceFiles(AbstractPushTask):
    """Push Namespace Files to Git"""
    branch: Property[str] = Property.ofValue("main")
    namespace: Property[str] = new Property<>("{{ flow.namespace }}")
