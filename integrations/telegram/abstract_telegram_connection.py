...
# Source: E:\KESTRA-IO\plugins\plugin-telegram\src\main\java\io\kestra\plugin\telegram\AbstractTelegramConnection.java
...
class AbstractTelegramConnection(ABC, Task):
