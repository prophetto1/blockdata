...
from integrations.opsgenie.opsgenie_template import OpsgenieTemplate
...
class OpsgenieExecution(OpsgenieTemplate, ExecutionInterface):
    """Send an Opsgenie notification with the execution information."""
