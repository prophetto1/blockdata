...
# Source: E:\KESTRA-IO\plugins\plugin-opsgenie\src\main\java\io\kestra\plugin\opsgenie\AbstractOpsgenieConnection.java
...
class AbstractOpsgenieConnection(ABC, Task):
