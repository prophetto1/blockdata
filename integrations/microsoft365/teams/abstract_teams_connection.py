...
# Source: E:\KESTRA-IO\plugins\plugin-microsoft365\src\main\java\io\kestra\plugin\microsoft365\teams\AbstractTeamsConnection.java
...
class AbstractTeamsConnection(ABC, Task):
