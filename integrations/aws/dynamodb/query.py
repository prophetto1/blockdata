...
# Source: E:\KESTRA-IO\plugins\plugin-aws\src\main\java\io\kestra\plugin\aws\dynamodb\Query.java
...
class Query(AbstractDynamoDb):
    """Query DynamoDB items by key condition"""
    key_condition_expression: Property[str]
    expression_attribute_values: Property[dict[str, Any]]
