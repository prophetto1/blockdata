...
class StartJobRun(AbstractGlueTask, RunnableTask):
    """Start a Glue job run"""
    job_name: Property[str]
    arguments: Property[dict[String, String]] | None = None
    ...
    def add_arguments_if_provided(self, run_context: RunContext, request_builder: StartJobRunRequest) -> None:
        raise NotImplementedError  # TODO: translate from Java
