...
# Source: E:\KESTRA-IO\plugins\plugin-gcp\src\main\java\io\kestra\plugin\gcp\dataproc\batches\PySparkSubmit.java
...
class PySparkSubmit(AbstractSparkSubmit):
    """Submit a PySpark batch to Dataproc"""
    main_python_file_uri: Property[str]
