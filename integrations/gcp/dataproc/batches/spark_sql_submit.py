...
# Source: E:\KESTRA-IO\plugins\plugin-gcp\src\main\java\io\kestra\plugin\gcp\dataproc\batches\SparkSqlSubmit.java
...
class SparkSqlSubmit(AbstractSparkSubmit):
    """Submit Spark SQL batch to Dataproc"""
    query_file_uri: Property[str]
