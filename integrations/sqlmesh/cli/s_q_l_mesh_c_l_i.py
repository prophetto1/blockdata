...
# Source: E:\KESTRA-IO\plugins\plugin-sqlmesh\src\main\java\io\kestra\plugin\sqlmesh\cli\SQLMeshCLI.java
...
class SQLMeshCLI(Task):
    """Run SQLMesh CLI workflows"""
    commands: Property[list[str]]
    d_e_f_a_u_l_t__i_m_a_g_e: ClassVar[str] = "ghcr.io/kestra-io/sqlmesh"
