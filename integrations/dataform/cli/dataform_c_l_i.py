...
# Source: E:\KESTRA-IO\plugins\plugin-dataform\src\main\java\io\kestra\plugin\dataform\cli\DataformCLI.java
...
class DataformCLI(Task):
    """Run Dataform CLI commands in Kestra"""
    commands: Property[list[str]]
    d_e_f_a_u_l_t__i_m_a_g_e: ClassVar[str] = "dataformco/dataform:latest"
