...
# Source: E:\KESTRA-IO\plugins\plugin-discord\src\main\java\io\kestra\plugin\discord\AbstractDiscordConnection.java
...
class AbstractDiscordConnection(ABC, Task):
