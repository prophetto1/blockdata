...
# Source: E:\KESTRA-IO\plugins\plugin-dropbox\src\main\java\io\kestra\plugin\dropbox\files\Move.java
...
class Move(Task):
    ...
    allow_ownership_transfer: Property[bool] = Property.ofValue(false)
