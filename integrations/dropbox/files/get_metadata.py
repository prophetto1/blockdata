...
# Source: E:\KESTRA-IO\plugins\plugin-dropbox\src\main\java\io\kestra\plugin\dropbox\files\GetMetadata.java
...
class GetMetadata(Task):
    """Retrieve Dropbox item metadata"""
    access_token: Property[str]
    path: Any
    include_media_info: Property[bool] = Property.ofValue(false)
