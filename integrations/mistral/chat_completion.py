...
# Source: E:\KESTRA-IO\plugins\plugin-mistral\src\main\java\io\kestra\plugin\mistral\ChatCompletion.java
...
class ChatCompletion(Task):
    ...
    base_url: Property[str] = Property.ofValue("https://api.mistral.ai/v1")
    ...
    @staticmethod
    def get_json_nodes(json_response_schema: str) -> ObjectNode:
        raise NotImplementedError  # TODO: translate from Java
