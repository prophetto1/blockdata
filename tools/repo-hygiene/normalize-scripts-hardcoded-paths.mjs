...
const DEFAULT_REPORT_PATH = '_collaborate/scripts/repo-hygiene/reports/scripts-hardcoded-path-audit.md';
...
const EXCLUDED_PATH_PREFIXES = [
  'scripts/logs/',
  '_collaborate/scripts/repo-hygiene/reports/',
];
...
Usage:
  node _collaborate/scripts/repo-hygiene/normalize-scripts-hardcoded-paths.mjs [options]
