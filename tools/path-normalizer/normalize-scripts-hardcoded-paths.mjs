...
const DEFAULT_REPORT_PATH = 'tools/path-normalizer/reports/scripts-hardcoded-path-audit.md';
...
const EXCLUDED_PATH_PREFIXES = ['scripts/logs/'];
...
Usage:
  node tools/path-normalizer/normalize-scripts-hardcoded-paths.mjs [options]
