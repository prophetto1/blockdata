...
export default function AgchainOrganizationMembersPage() {
  ...
  return (
    <AgchainStandardSurface title="Organization Members" bodyClassName="space-y-6">
      <div className="border-b border-border/60 pb-6">
        <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
          <div className="min-w-0 space-y-2">
            <p className="max-w-3xl text-sm leading-7 text-muted-foreground">
              Manage membership for the current AGChain organization, including protected owners and invited teammates.
            </p>
