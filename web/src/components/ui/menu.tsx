...
function MenuTrigger({
  ...
  const triggerClassName = asChild
    ...
    : cn(
      ...
      'transition-colors hover:bg-[#222221]',
...
function MenuContent({
  ...
  return (
    <ArkMenu.Content
      className={cn(
        'ui-menu-content',
        'min-w-[8rem] overflow-hidden rounded-md border border-[#3a3a3a] bg-popover p-1 text-popover-foreground shadow-[0_4px_6px_-1px_rgb(0_0_0/0.2),0_2px_4px_-2px_rgb(0_0_0/0.12)]',
