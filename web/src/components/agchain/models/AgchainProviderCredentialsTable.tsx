...
export function AgchainProviderCredentialsTable({
  ...
  return (
    <section className="rounded-3xl border border-border/70 bg-card/60 shadow-sm">
        ...
        <div className="flex flex-wrap items-center gap-2">
          <label className="relative min-w-[240px] max-w-sm flex-1">
            ...
            <input
              ...
              className="h-10 w-full rounded-md border border-border/70 bg-background/80 pl-8 pr-3 text-sm text-foreground outline-none focus-visible:ring-1 focus-visible:ring-ring"
            />
          </label>
          <button
            type="button"
                  ...
                  Array.from(groupedRows.entries()).map(([category, providers]) => (
                    <Fragment key={category}>
                      <tr className="border-b border-border bg-muted/20">
                        <td colSpan={4} className="px-3 py-2 text-[11px] font-medium text-muted-foreground">
                          {category}
                        </td>
                      </tr>
                      {providers.map((provider) => {
                        ...
                        return (
                          <tr key={provider.provider_slug} className="border-b border-border/60 align-top hover:bg-accent/30">
