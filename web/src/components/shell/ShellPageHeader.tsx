...
function ShellPageHeaderContent({ title, description, eyebrow, action }: ShellPageHeaderProps) {
  return (
    <div data-testid="shell-page-header-content" className="min-w-0">
...
export function ShellPageHeader(props: ShellPageHeaderProps) {
  ...
  const pageHeaderNode = useMemo(
    () => <ShellPageHeaderContent {...props} />,
    [props.action, props.description, props.eyebrow, props.title],
  );
