...
import {
  fetchBlockdataAdminProviderDefinitions,
  fetchBlockdataAdminProviderModels,
...
type SharedAdminRegistryState = {
  ...
  providers: BlockdataAdminProviderDefinition[] | null;
  models: BlockdataAdminProviderModel[] | null;
  status: AdminRegistryStatus;
  error: string | null;
};

type BlockdataAdminRegistryState = {
  providers: BlockdataAdminProviderDefinition[] | null;
  models: BlockdataAdminProviderModel[] | null;
  status: AdminRegistryStatus;
  error: string | null;
...
export function useBlockdataAdminAiProviderRegistry(): BlockdataAdminRegistryState {
...
export function resetBlockdataAdminAiProviderRegistryStateForTests() {
  resetSharedAdminRegistryState();
}
