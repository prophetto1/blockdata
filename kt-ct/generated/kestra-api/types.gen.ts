...
export type QueryFilterField = 'QUERY' | 'SCOPE' | 'NAMESPACE' | 'KIND' | 'LABELS' | 'METADATA' | 'FLOW_ID' | 'FLOW_REVISION' | 'ID' | 'ASSET_ID' | 'TYPE' | 'CREATED' | 'UPDATED' | 'START_DATE' | 'END_DATE' | 'EXPIRATION_DATE' | 'STATE' | 'TIME_RANGE' | 'TRIGGER_EXECUTION_ID' | 'TRIGGER_ID' | 'TRIGGER_STATE' | 'EXECUTION_ID' | 'TASK_ID' | 'TASK_RUN_ID' | 'CHILD_FILTER' | 'WORKER_ID' | 'EXISTING_ONLY' | 'MIN_LEVEL' | 'PATH' | 'PARENT_PATH' | 'VERSION' | 'USERNAME';
