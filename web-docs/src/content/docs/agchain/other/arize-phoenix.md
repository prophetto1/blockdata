---
title: "Arize Phoenix documentation index"
sidebar:
  order: 2
---
...
- [Tracing Features](https://arize.com/docs/phoenix/tracing/features-tracing): Discover tracing capabilities â€” auto-instrumentation, manual spans, annotations, sessions
...
- [Pre-Built Metrics](https://arize.com/docs/phoenix/evaluation/pre-built-metrics): All pre-built LLM and code evaluators â€” faithfulness, hallucination, toxicity, RAG relevance, tool calling, and more
...
- [Server Pre-Built Metrics](https://arize.com/docs/phoenix/evaluation/server-evals/pre-built-metrics): All server-side code metrics â€” contains, exact match, regex, JSON distance, Levenshtein, tool selection/invocation
...
- [Integrations Overview](https://arize.com/docs/phoenix/integrations): All Phoenix integrations â€” LLM providers, frameworks, platforms
...
- [Phoenix OTEL (TS)](https://arize.com/docs/phoenix/sdk-api-reference/typescript/arizeai-phoenix-otel): Configure OpenTelemetry tracing via @arizeai/phoenix-otel
...
- [Cookbook Index](https://arize.com/docs/phoenix/cookbook): All examples â€” agents, evaluation, tracing, prompt engineering, datasets
