---
title: "dbt Integration Design: Database Source Transform Options"
description: "Borrow Mage AI's dbt execution layer (dbtRunner, DBTCli, profile interpolation, source generation) and integrate dbt commands as database source transform options in blockdata. dbt becomes a set of action types callable from both the Transform surface and Eternity Canvas."
