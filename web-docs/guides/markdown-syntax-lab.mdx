...
- Internal page: [API Overview](/api/overview)
...
<CardGroup cols={2}>
  ...
  <Card title="Function Catalog" icon="list" href="/api/core">
...
Fill in after reviewing the live site.

| Feature | Section | Expected | Renders? |
| ------- | ------- | -------- | -------- |
| Bold / italic / inline code | 1 | ✅ | |
| Strikethrough `~~` | 3 | ✅ | |
| Tables with alignment | 4 | ✅ | |
| Task list `[ ]` / `[x]` | 5 | ❓ | |
| Footnotes `[^1]` | 9 | ❌ | |
| Definition list (MD) | 10 | ❌ | |
| Custom heading ID `{#id}` | 11 | ❌ | |
| Emoji shortcodes `:rocket:` | 12 | ❌ | |
| Highlight `==text==` | 2 | ❌ | |
| Superscript `^2^` | 2 | ❌ | |
| Subscript `~2~` | 2 | ❌ | |
| `<sup>` / `<sub>` HTML | 2 | ✅ | |
| `<mark>` HTML | 13 | ⚠️ unstyled | |
| `<details>` / `<summary>` | 13 | ⚠️ check | |
| `<kbd>` | 13 | ⚠️ check | |
| `<dl>` HTML | 13 | ⚠️ check | |
| Inline math `$...$` | 8 | ✅ | |
| Block math `$$...$$` | 8 | ✅ | |
| Code — syntax highlight | 7 | ✅ | |
| Code — title label | 7 | ✅ | |
| Code — line highlight `{n}` | 7 | ✅ | |
| Code — line numbers | 7 | ✅ | |
| Code — diff `[!code ++/--]` | 7 | ✅ | |
| Note / Tip / Warning | 14 | ✅ | |
| Info / Check / Caution | 14 | ✅ | |
| Tabs | 15 | ✅ | |
| AccordionGroup / Accordion | 16 | ✅ | |
| CardGroup / Card | 17 | ✅ | |
| Steps / Step | 18 | ✅ | |
| Columns | 19 | ✅ | |
| ParamField | 20 | ✅ | |
