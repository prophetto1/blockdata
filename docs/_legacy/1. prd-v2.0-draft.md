...
BlockData (working name) is a document intelligence platform that turns unstructured documents into a **permanent, identity-bearing block inventory** that users can annotate with **swappable schemas** to enable parallel AI processing, multi-lens analysis, and downstream exports.
