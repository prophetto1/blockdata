---
title: "Frontend ↔ Database Audit Report — 2026-02-20"
description: "Comprehensive audit of every frontend page, hook, and component against the current database schema. Covers table references, RPC calls, realtime subscriptions, and RLS policies."
