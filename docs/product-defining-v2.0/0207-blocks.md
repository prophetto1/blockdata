...
**3. Use the specifications to plan, design, and develop key web pages necessary to get this project off the ground, including one or two non-auth pages and 4-5 key auth-gated pages.**

Candidate pages.

Non-auth: landing, login
Auth-gated: main dashboard default after login, add project, add user-schema, main project-view page, exporting json/jsonl files and any other that can be derived from the document.
