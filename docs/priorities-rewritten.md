...
4. Clarify frontend scope.
   Separate flow UI, non-flow operational features, testing surfaces, blueprints, and admin/runtime configuration. Make the near-term flow goal explicit: we should be able to enter a flow and inspect its tab structure before expanding the broader runtime surface.
