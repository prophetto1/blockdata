---
title: "Callback Contract: Conversion Service → conversion-complete Edge Function"
description: "**Direction:** Python conversion service → `POST /functions/v1/conversion-complete`"
