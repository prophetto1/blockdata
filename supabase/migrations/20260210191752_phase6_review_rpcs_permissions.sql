-- Migration 013: Phase 6 review RPCs + permissions hardening
-- - Add reject_overlays_to_pending RPC for per-block reject controls
-- - Restrict authenticated direct UPDATE access to staging column only
