-- Exact Kestra schema transplant into sibling schema kt.

CREATE SCHEMA IF NOT EXISTS kt;

CREATE TYPE kt.log_level AS ENUM (
    'ERROR',
    'WARN',
    'INFO',
    'DEBUG',
...
CREATE TYPE kt.queue_type AS ENUM (
...
CREATE TYPE kt.state_type AS ENUM (
    'CREATED',
    'RUNNING',
    'PAUSED',
    'RESTARTED',
...
CREATE FUNCTION kt.fulltext_replace(text, text) RETURNS text
...
CREATE FUNCTION kt.fulltext_index(text) RETURNS tsvector
    LANGUAGE sql IMMUTABLE STRICT
    RETURN (to_tsvector('simple'::regconfig, kt.fulltext_replace($1, ' '::text)) || to_tsvector('simple'::regconfig, $1));
...
CREATE FUNCTION kt.fulltext_search(text) RETURNS tsquery
    LANGUAGE sql IMMUTABLE STRICT
    RETURN CASE WHEN (kt.fulltext_replace($1, ''::text) = ''::text) THEN to_tsquery(''::text) ELSE to_tsquery('simple'::regconfig, (kt.fulltext_replace($1, ':* & '::text) || ':*'::text)) END;
...
CREATE FUNCTION kt.loglevel_fromtext(text) RETURNS kt.log_level
    LANGUAGE sql IMMUTABLE
    RETURN ($1)::kt.log_level;
...
CREATE FUNCTION kt.parse_iso8601_datetime(text) RETURNS timestamp with time zone
    LANGUAGE sql IMMUTABLE
...
CREATE FUNCTION kt.parse_iso8601_duration(text) RETURNS interval
    LANGUAGE sql IMMUTABLE
    RETURN ($1)::interval;
...
CREATE FUNCTION kt.parse_iso8601_timestamp(text) RETURNS integer
    LANGUAGE sql IMMUTABLE
...
CREATE FUNCTION kt.state_fromtext(text) RETURNS kt.state_type
    LANGUAGE sql IMMUTABLE
    RETURN ($1)::kt.state_type;
...
CREATE FUNCTION kt.update_updated_datetime() RETURNS trigger
    LANGUAGE plpgsql
    AS $$
BEGIN
    NEW.updated = now();
...
CREATE TABLE kt.concurrency_limit (
...
CREATE TABLE kt.dashboards (
    ...
    fulltext tsvector GENERATED ALWAYS AS (kt.fulltext_index((((value ->> 'title'::text))::character varying)::text)) STORED,
...
CREATE TABLE kt.execution_queued (
    key character varying(250) NOT NULL,
    value jsonb NOT NULL,
    tenant_id character varying(250) GENERATED ALWAYS AS ((value ->> 'tenantId'::text)) STORED,
    namespace character varying(150) GENERATED ALWAYS AS ((value ->> 'namespace'::text)) STORED NOT NULL,
    flow_id character varying(150) GENERATED ALWAYS AS ((value ->> 'flowId'::text)) STORED NOT NULL,
    date timestamp with time zone GENERATED ALWAYS AS (kt.parse_iso8601_datetime((value ->> 'date'::text))) STORED NOT NULL
);
...
CREATE TABLE kt.executions (
    key character varying(250) NOT NULL,
    value jsonb NOT NULL,
    deleted boolean GENERATED ALWAYS AS (((value ->> 'deleted'::text))::boolean) STORED NOT NULL,
    namespace character varying(150) GENERATED ALWAYS AS ((value ->> 'namespace'::text)) STORED NOT NULL,
    flow_id character varying(150) GENERATED ALWAYS AS ((value ->> 'flowId'::text)) STORED NOT NULL,
    state_current kt.state_type GENERATED ALWAYS AS (kt.state_fromtext((value #>> '{state,current}'::text[]))) STORED NOT NULL,
    state_duration bigint GENERATED ALWAYS AS (EXTRACT(milliseconds FROM kt.parse_iso8601_duration((value #>> '{state,duration}'::text[])))) STORED,
    start_date timestamp without time zone GENERATED ALWAYS AS (kt.parse_iso8601_datetime((value #>> '{state,startDate}'::text[]))) STORED NOT NULL,
    end_date timestamp without time zone GENERATED ALWAYS AS (kt.parse_iso8601_datetime((value #>> '{state,endDate}'::text[]))) STORED,
    fulltext tsvector GENERATED ALWAYS AS (((kt.fulltext_index((((value ->> 'namespace'::text))::character varying)::text) || kt.fulltext_index((((value ->> 'flowId'::text))::character varying)::text)) || kt.fulltext_index((((value ->> 'id'::text))::character varying)::text))) STORED,
...
CREATE TABLE kt.executordelayed (
    key character varying(250) NOT NULL,
    value jsonb NOT NULL,
    date timestamp with time zone GENERATED ALWAYS AS (kt.parse_iso8601_datetime((value ->> 'date'::text))) STORED NOT NULL
);
...
CREATE TABLE kt.flow_topologies (
    key character varying(250) NOT NULL,
    value jsonb NOT NULL,
...
CREATE TABLE kt.flows (
    ...
    fulltext tsvector GENERATED ALWAYS AS ((kt.fulltext_index((((value ->> 'namespace'::text))::character varying)::text) || kt.fulltext_index((((value ->> 'id'::text))::character varying)::text))) STORED,
    source_code text NOT NULL,
    tenant_id character varying(250) GENERATED ALWAYS AS ((value ->> 'tenantId'::text)) STORED,
...
CREATE TABLE kt.flyway_schema_history (
...
CREATE TABLE kt.kv_metadata (
    ...
    expiration_date timestamp with time zone GENERATED ALWAYS AS (kt.parse_iso8601_datetime((value ->> 'expirationDate'::text))) STORED,
    updated timestamp with time zone DEFAULT CURRENT_TIMESTAMP NOT NULL,
    deleted boolean GENERATED ALWAYS AS (((value ->> 'deleted'::text))::boolean) STORED NOT NULL,
    fulltext tsvector GENERATED ALWAYS AS (kt.fulltext_index((((value ->> 'name'::text))::character varying)::text)) STORED,
    created timestamp with time zone GENERATED ALWAYS AS (kt.parse_iso8601_datetime(COALESCE((value ->> 'created'::text), (value ->> 'updated'::text)))) STORED NOT NULL
);
...
CREATE TABLE kt.logs (
    ...
    level kt.log_level GENERATED ALWAYS AS (kt.loglevel_fromtext((value ->> 'level'::text))) STORED NOT NULL,
    "timestamp" timestamp with time zone GENERATED ALWAYS AS (kt.parse_iso8601_datetime((value ->> 'timestamp'::text))) STORED NOT NULL,
    tenant_id character varying(250) GENERATED ALWAYS AS ((value ->> 'tenantId'::text)) STORED,
    fulltext tsvector GENERATED ALWAYS AS ((((((((kt.fulltext_index((((value ->> 'namespace'::text))::character varying)::text) || kt.fulltext_index((((value ->> 'flowId'::text))::character varying)::text)) || kt.fulltext_index((COALESCE(((value ->> 'taskId'::text))::character varying, ''::character varying))::text)) || kt.fulltext_index((COALESCE(((value ->> 'executionId'::text))::character varying, ''::character varying))::text)) || kt.fulltext_index((COALESCE(((value ->> 'taskRunId'::text))::character varying, ''::character varying))::text)) || kt.fulltext_index((COALESCE(((value ->> 'triggerId'::text))::character varying, ''::character varying))::text)) || kt.fulltext_index((COALESCE(((value ->> 'message'::text))::character varying, ''::character varying))::text)) || kt.fulltext_index((COALESCE(((value ->> 'thread'::text))::character varying, ''::character varying))::text))) STORED,
...
CREATE TABLE kt.multipleconditions (
    key character varying(250) NOT NULL,
    value jsonb NOT NULL,
    namespace character varying(150) GENERATED ALWAYS AS ((value ->> 'namespace'::text)) STORED NOT NULL,
    flow_id character varying(150) GENERATED ALWAYS AS ((value ->> 'flowId'::text)) STORED NOT NULL,
    condition_id character varying(150) GENERATED ALWAYS AS ((value ->> 'conditionId'::text)) STORED NOT NULL,
    start_date timestamp with time zone GENERATED ALWAYS AS (kt.parse_iso8601_datetime((value ->> 'start'::text))) STORED NOT NULL,
    end_date timestamp with time zone GENERATED ALWAYS AS (kt.parse_iso8601_datetime((value ->> 'end'::text))) STORED NOT NULL,
    tenant_id character varying(250) GENERATED ALWAYS AS ((value ->> 'tenantId'::text)) STORED
);
...
CREATE TABLE kt.namespace_file_metadata (
    key character varying(768) NOT NULL,
    value jsonb NOT NULL,
    tenant_id character varying(250) GENERATED ALWAYS AS ((value ->> 'tenantId'::text)) STORED,
    namespace character varying(150) GENERATED ALWAYS AS ((value ->> 'namespace'::text)) STORED NOT NULL,
    ...
    created timestamp with time zone GENERATED ALWAYS AS (kt.parse_iso8601_datetime((value ->> 'created'::text))) STORED NOT NULL,
    updated timestamp with time zone GENERATED ALWAYS AS (kt.parse_iso8601_datetime((value ->> 'updated'::text))) STORED NOT NULL,
    deleted boolean GENERATED ALWAYS AS (((value ->> 'deleted'::text))::boolean) STORED NOT NULL,
    fulltext tsvector GENERATED ALWAYS AS (kt.fulltext_index((((value ->> 'path'::text))::character varying)::text)) STORED
);
...
CREATE TABLE kt.queues (
    "offset" bigint NOT NULL,
    type kt.queue_type NOT NULL,
    key character varying(250) NOT NULL,
    value jsonb NOT NULL,
...
CREATE SEQUENCE kt.queues_offset_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE kt.queues_offset_seq OWNED BY kt.queues."offset";
...
CREATE TABLE kt.service_instance (
    key character varying(250) NOT NULL,
    value jsonb NOT NULL,
    ...
    created_at timestamp with time zone GENERATED ALWAYS AS (kt.parse_iso8601_datetime((value ->> 'createdAt'::text))) STORED NOT NULL,
    updated_at timestamp with time zone GENERATED ALWAYS AS (kt.parse_iso8601_datetime((value ->> 'updatedAt'::text))) STORED NOT NULL
);
...
CREATE TABLE kt.sla_monitor (
    key character varying(250) NOT NULL,
    value jsonb NOT NULL,
    execution_id character varying(150) GENERATED ALWAYS AS ((value ->> 'executionId'::text)) STORED NOT NULL,
    sla_id character varying(150) GENERATED ALWAYS AS ((value ->> 'slaId'::text)) STORED NOT NULL,
    deadline timestamp with time zone GENERATED ALWAYS AS (kt.parse_iso8601_datetime((value ->> 'deadline'::text))) STORED NOT NULL
);
...
CREATE TABLE kt.templates (
    key character varying(250) NOT NULL,
    value jsonb NOT NULL,
    deleted boolean GENERATED ALWAYS AS (((value ->> 'deleted'::text))::boolean) STORED NOT NULL,
    id character varying(100) GENERATED ALWAYS AS ((value ->> 'id'::text)) STORED NOT NULL,
    namespace character varying(150) GENERATED ALWAYS AS ((value ->> 'namespace'::text)) STORED NOT NULL,
    fulltext tsvector GENERATED ALWAYS AS (kt.fulltext_index(((kt.fulltext_replace((((value ->> 'namespace'::text))::character varying)::text, ' '::text) || ' '::text) || kt.fulltext_replace((((value ->> 'id'::text))::character varying)::text, ' '::text)))) STORED,
    tenant_id character varying(250) GENERATED ALWAYS AS ((value ->> 'tenantId'::text)) STORED
);
...
CREATE TABLE kt.triggers (
    ...
    execution_id character varying(150) GENERATED ALWAYS AS ((value ->> 'executionId'::text)) STORED,
    fulltext tsvector GENERATED ALWAYS AS ((((kt.fulltext_index((((value ->> 'namespace'::text))::character varying)::text) || kt.fulltext_index((((value ->> 'flowId'::text))::character varying)::text)) || kt.fulltext_index((((value ->> 'triggerId'::text))::character varying)::text)) || kt.fulltext_index((COALESCE(((value ->> 'executionId'::text))::character varying, ''::character varying))::text))) STORED,
    tenant_id character varying(250) GENERATED ALWAYS AS ((value ->> 'tenantId'::text)) STORED,
    next_execution_date timestamp with time zone GENERATED ALWAYS AS (kt.parse_iso8601_datetime((value ->> 'nextExecutionDate'::text))) STORED,
...
CREATE TABLE kt.worker_job_running (
    key character varying(250) NOT NULL,
    value jsonb NOT NULL,
...
ALTER TABLE ONLY kt.queues ALTER COLUMN "offset" SET DEFAULT nextval('kt.queues_offset_seq'::regclass);
...
ALTER TABLE ONLY kt.concurrency_limit
...
ALTER TABLE ONLY kt.dashboards
...
ALTER TABLE ONLY kt.execution_queued
...
ALTER TABLE ONLY kt.executions
...
ALTER TABLE ONLY kt.executordelayed
...
ALTER TABLE ONLY kt.executorstate
...
ALTER TABLE ONLY kt.flow_topologies
...
ALTER TABLE ONLY kt.flyway_schema_history
...
ALTER TABLE ONLY kt.kv_metadata
...
ALTER TABLE ONLY kt.multipleconditions
...
ALTER TABLE ONLY kt.namespace_file_metadata
...
ALTER TABLE ONLY kt.service_instance
...
ALTER TABLE ONLY kt.sla_monitor
...
ALTER TABLE ONLY kt.worker_job_running
...
CREATE INDEX concurrency_limit__flow ON kt.concurrency_limit USING btree (tenant_id, namespace, flow_id);
...
CREATE INDEX dashboards_fulltext ON kt.dashboards USING gin (fulltext);
...
CREATE INDEX dashboards_id ON kt.dashboards USING btree (id, deleted, tenant_id);
...
CREATE INDEX dashboards_tenant ON kt.dashboards USING btree (deleted, tenant_id);
...
CREATE INDEX execution_queued__flow_date ON kt.execution_queued USING btree (tenant_id, namespace, flow_id, date);
...
CREATE INDEX executions_end_date ON kt.executions USING btree (deleted, tenant_id, end_date);
...
CREATE INDEX executions_flow_id ON kt.executions USING btree (deleted, tenant_id, flow_id);
...
CREATE INDEX executions_fulltext ON kt.executions USING gin (fulltext);
...
CREATE INDEX executions_labels ON kt.executions USING gin (((value -> 'labels'::text)));
...
CREATE INDEX executions_namespace ON kt.executions USING btree (deleted, tenant_id, namespace);
...
CREATE INDEX executions_start_date ON kt.executions USING btree (deleted, tenant_id, start_date);
...
CREATE INDEX executions_state_current ON kt.executions USING btree (deleted, tenant_id, state_current);
...
CREATE INDEX executions_state_duration ON kt.executions USING btree (deleted, tenant_id, state_duration);
...
CREATE INDEX executions_trigger_execution_id ON kt.executions USING btree (deleted, tenant_id, trigger_execution_id);
...
CREATE INDEX executordelayed_date ON kt.executordelayed USING btree (date);
...
CREATE INDEX flow_topologies_destination ON kt.flow_topologies USING btree (destination_tenant_id, destination_namespace, destination_id);
...
CREATE INDEX flow_topologies_destination__source ON kt.flow_topologies USING btree (destination_tenant_id, destination_namespace, destination_id, source_tenant_id, source_namespace, source_id);
...
CREATE INDEX flows_fulltext ON kt.flows USING gin (fulltext);
...
CREATE INDEX flows_labels ON kt.flows USING gin (((value -> 'labels'::text)));
...
CREATE INDEX flows_namespace ON kt.flows USING btree (deleted, tenant_id, namespace);
...
CREATE INDEX flows_namespace__id__revision ON kt.flows USING btree (deleted, tenant_id, namespace, id, revision);
...
CREATE INDEX flows_source_code ON kt.flows USING gin (kt.fulltext_index(source_code));
...
CREATE INDEX flyway_schema_history_s_idx ON kt.flyway_schema_history USING btree (success);
...
CREATE INDEX ix_last_deleted_tenant_name_version ON kt.kv_metadata USING btree (last, deleted, tenant_id, name, version);
...
CREATE INDEX ix_last_deleted_tenant_namespace_name ON kt.kv_metadata USING btree (last, deleted, tenant_id, namespace, name);
...
CREATE INDEX ix_last_deleted_tenant_namespace_name_version ON kt.kv_metadata USING btree (last, deleted, tenant_id, namespace, name, version);
...
CREATE INDEX ix_last_deleted_tenant_namespace_parent_path ON kt.namespace_file_metadata USING btree (last, deleted, tenant_id, namespace, parent_path);
...
CREATE INDEX ix_last_deleted_tenant_namespace_path ON kt.namespace_file_metadata USING btree (last, deleted, tenant_id, namespace, path);
...
CREATE INDEX ix_last_deleted_tenant_namespace_path_version ON kt.namespace_file_metadata USING btree (last, deleted, tenant_id, namespace, path, version);
...
CREATE INDEX ix_last_deleted_tenant_namespace_version ON kt.kv_metadata USING btree (last, deleted, tenant_id, namespace, version);
...
CREATE INDEX ix_last_deleted_tenant_path_version ON kt.namespace_file_metadata USING btree (last, deleted, tenant_id, path, version);
...
CREATE UNIQUE INDEX ix_service_id ON kt.service_instance USING btree (service_id);
...
CREATE INDEX ix_service_instance_state ON kt.service_instance USING btree (state);
...
CREATE INDEX ix_service_instance_type_created_at_updated_at ON kt.service_instance USING btree (service_type, created_at, updated_at);
...
CREATE INDEX logs_execution_id ON kt.logs USING btree (execution_id);
...
CREATE INDEX logs_execution_id__task_id ON kt.logs USING btree (execution_id, task_id);
...
CREATE INDEX logs_execution_id__taskrun_id ON kt.logs USING btree (execution_id, taskrun_id);
...
CREATE INDEX logs_tenant_namespace_timestamp ON kt.logs USING btree (tenant_id, namespace, "timestamp", level);
...
CREATE INDEX logs_tenant_timestamp ON kt.logs USING btree (tenant_id, "timestamp", level);
...
CREATE INDEX logs_timestamp ON kt.logs USING btree ("timestamp");
...
CREATE INDEX metrics_execution_id ON kt.metrics USING btree (execution_id);
...
CREATE INDEX metrics_flow_id ON kt.metrics USING btree (tenant_id, namespace, flow_id);
...
CREATE INDEX metrics_timestamp ON kt.metrics USING btree (tenant_id, "timestamp");
...
CREATE INDEX multipleconditions_namespace__flow_id__condition_id ON kt.multipleconditions USING btree (tenant_id, namespace, flow_id, condition_id);
...
CREATE INDEX multipleconditions_start_date__end_date ON kt.multipleconditions USING btree (tenant_id, start_date, end_date);
...
CREATE INDEX queues_offset ON kt.queues USING hash ("offset");
...
CREATE INDEX queues_type__consumer_executor ON kt.queues USING btree (type, consumer_executor, "offset") WHERE (consumer_executor = false);
...
CREATE INDEX queues_type__consumer_flow_topology ON kt.queues USING btree (type, consumer_flow_topology, "offset") WHERE (consumer_flow_topology = false);
...
CREATE INDEX queues_type__consumer_indexer ON kt.queues USING btree (type, consumer_indexer, "offset") WHERE (consumer_indexer = false);
...
CREATE INDEX queues_type__consumer_scheduler ON kt.queues USING btree (type, consumer_scheduler, "offset") WHERE (consumer_scheduler = false);
...
CREATE INDEX queues_type__consumer_worker ON kt.queues USING btree (type, consumer_worker, "offset") WHERE (consumer_worker = false);
...
CREATE INDEX queues_type__key ON kt.queues USING btree (type, key);
...
CREATE INDEX queues_type__offset ON kt.queues USING btree (type, "offset");
...
CREATE INDEX queues_updated ON kt.queues USING btree (updated);
...
CREATE INDEX sla_monitor__deadline ON kt.sla_monitor USING btree (deadline);
...
CREATE INDEX sla_monitor__execution_id ON kt.sla_monitor USING btree (execution_id);
...
CREATE INDEX templates_fulltext ON kt.templates USING gin (fulltext);
...
CREATE INDEX templates_namespace ON kt.templates USING btree (deleted, tenant_id, namespace);
...
CREATE INDEX templates_namespace__id ON kt.templates USING btree (deleted, tenant_id, namespace, id);
...
CREATE INDEX triggers__tenant ON kt.triggers USING btree (tenant_id);
...
CREATE INDEX triggers_execution_id ON kt.triggers USING btree (execution_id);
...
CREATE INDEX triggers_next_execution_date ON kt.triggers USING btree (next_execution_date);
...
CREATE INDEX worker_job_running_worker_uuid ON kt.worker_job_running USING btree (worker_uuid);
...
CREATE TRIGGER dashboard_updated BEFORE UPDATE ON kt.dashboards FOR EACH ROW EXECUTE FUNCTION kt.update_updated_datetime();
...
CREATE TRIGGER kv_metadata_updated BEFORE UPDATE ON kt.kv_metadata FOR EACH ROW EXECUTE FUNCTION kt.update_updated_datetime();
...
CREATE TRIGGER namespace_file_metadata_updated BEFORE UPDATE ON kt.namespace_file_metadata FOR EACH ROW EXECUTE FUNCTION kt.update_updated_datetime();
...
CREATE TRIGGER queues_updated BEFORE UPDATE ON kt.queues FOR EACH ROW EXECUTE FUNCTION kt.update_updated_datetime();
