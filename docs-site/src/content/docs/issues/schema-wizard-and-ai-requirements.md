---
title: Schema Wizard + AI-Assisted Schema Creation
description: Requirements for a manual-first schema builder wizard with optional AI-assisted field and prompt generation.
sidebar:
  order: 1
---
