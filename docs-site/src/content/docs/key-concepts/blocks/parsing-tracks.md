...
It does **not** cover: block type normalization (see [Block Types](/docs/key-concepts/blocks/block-types/)) or field definitions (see [Immutable Fields](/docs/key-concepts/schemas/immutable-schema/)).
