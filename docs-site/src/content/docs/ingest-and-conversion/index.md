...
Format routing determines which track processes each source type. See [Parsing Tracks](/docs/blocks/parsing-tracks/) for the canonical routing table and capability comparison.
...
- [Current Ongoing Work](/docs/ongoing-work/)
