...
It does **not** cover: field definitions (see [Immutable Fields](/docs/schemas/immutable-schema/)), block types (see [Block Types](/docs/blocks/block-types/)), or overlay confirmation semantics (see [Overlay Contract](/docs/review-and-export/overlay-contract/)).
