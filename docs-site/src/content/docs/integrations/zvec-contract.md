---
title: Zvec Integration Contract
description: Prescriptive contract for mapping BlockData exports into Zvec records and collection schema.
sidebar:
  order: 1
---
...
**Spec version:** v0.1  
**Date:** 2026-02-12  
**Source:** `docs/integrations/zvec/zvec-integration-contract.md`  
...
This page defines the target BlockData -> Zvec integration contract:
- canonical intermediate record (`vector_record_v1`),
- mapping into Zvec schema and docs,
- idempotent upsert/query behavior.

It does not cover implementation sequencing or runtime task plans.

---

<!-- BEGIN VERBATIM COPY from docs/integrations/zvec/zvec-integration-contract.md -->
